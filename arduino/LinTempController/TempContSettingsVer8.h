...
namespace Settings
{
	...
	const float dac_vref(1.2478); //value of DAC's internal voltage reference
        ...
        const float dac_offset[4] = {-0.0019,0.0023,-0.0015,-0.0015}; //offset between the commanded and actual DAC voltage, typically ~1-2 mV
	...
	const float int_tc_max(10.0); //max allowed integrator time constant (sec) (above 3.4sec each turn of rot encoder doesn't always change pot value)
        ...
        const unsigned long pot_max[4] = {223100UL, 223200UL, 223000UL, 227100UL};
        const unsigned long pot_min[4] = {1080UL, 1100UL, 1100UL, 1100UL};
        ...
        const byte versionNum(8); //Calibrated 1/12/16 CBP
