...
namespace Settings
{
	...
	const float analog_vref(2.4988);  //value of voltage reference used for analog inputs
	...
	const float dac_vref(1.2469); //value of DAC's internal voltage reference
        ...
        const float dac_offset[4] = {-0.0026,0.0020,0.0014,-0.0010}; //offset between the commanded and actual DAC voltage, typically ~1-2 mV
	...
	const float int_tc_max(10.0); //max allowed integrator time constant (sec) (above 3.4sec each turn of rot encoder doesn't always change pot value)
        ...
        const unsigned long pot_max[4] = {229400UL, 224100UL, 223700UL, 223300UL};
        ...
        const byte versionNum(6);  //Calibrated 1/11/16 BJR
